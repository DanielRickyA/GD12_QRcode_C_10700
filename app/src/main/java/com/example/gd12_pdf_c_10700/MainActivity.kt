package com.example.gd12_pdf_c_10700
...
import com.example.gd12_pdf_c_10700.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val cameraActivityResultLauncer = registerForActivityResult(
        ...
        if(result.resultCode == Activity.RESULT_OK){
            ...
            Log.d(TAG, "cameraActivityResultLauncer: imageUri: $imageUri")
    ...
    private val galleryActivityResultLauncer = registerForActivityResult(
        ...
        if(result.resultCode == Activity.RESULT_OK){
            val data = result.data
            imageUri = data!!.data
            Log.d(TAG, "galleryActivityResultLauncer: imageUri: $imageUri")
            binding.imageTv.setImageURI(imageUri)
        }else{
